...
- **Collection Image Ratio:** The default `collection.json` template uses `image_ratio: "portrait"` (4:5, `--ratio-percent: 125%`). Other collection templates may still use `"square"` or other values. Changing this setting affects card media container height and crop behavior.
